...
# 文件路径 (直接硬编码完整路径以避免转义问题)
DEMAND_FEATURES_FILE = r'C:\Users\hk\fire_flower\2025年度"火花杯"数学建模精英联赛-B题-附件\demand_features.csv'
TRIPDATA_FILE = r'C:\Users\hk\fire_flower\2025年度"火花杯"数学建模精英联赛-B题-附件\202503-capitalbikeshare-tripdata.csv'
